...
from old_implementation.DQN import DQNAgent
from old_implementation.Player import Player
from old_implementation.Deck import Deck
import numpy as np
import sys
        ...
        while not gameOver:
            ...
            if random.uniform(0, 1) < agent.epsilon:
                ...
                while not played:
                    ...
                    played = player.action(deck, final_move)
                ...
                prediction = agent.model.predict(state_old.reshape(agent.state_shape))
