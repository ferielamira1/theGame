...
class TestDQN(unittest.TestCase):
    ...
    def test_init(self):
        ...
        print(self.assertEqual(agent.replay_memory_init_size, 0))
        print(self.assertEqual(agent.update_target_estimator_every, 0))
    ...
    def test_train(self):
        ...
        predicted_action, _ = agent.eval_step(np.random.random_sample((2,)),  [0, 1])
