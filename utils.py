...
def tournament(env, num):
    ...
    while counter < num:
        ...
        pass_count=env.action_recorder

        for p_id, action in pass_count:
            if p_id == 0:
                num_pass += 1
        ...
        if isinstance(_payoffs, list):
            ...
            counter += 1
        if _payoffs[0]> highest_payoff:
            highest_payoff = _payoffs[0]
    ...
    num_pass/=counter
    return payoffs,highest_payoff,num_pass
